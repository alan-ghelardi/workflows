...
var workflowsResource = schema.GroupVersionResource{Group: "workflows.dev", Version: "v1alpha1", Resource: "workflows"}

var workflowsKind = schema.GroupVersionKind{Group: "workflows.dev", Version: "v1alpha1", Kind: "Workflow"}
