...
import (
	...
	versionedscheme "github.com/nubank/workflows/pkg/client/clientset/versioned/scheme"
	client "github.com/nubank/workflows/pkg/client/injection/client"
	workflow "github.com/nubank/workflows/pkg/client/injection/informers/workflows/v1alpha1/workflow"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "workflows.workflows.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "workflows.dev.Workflow"),
	)
